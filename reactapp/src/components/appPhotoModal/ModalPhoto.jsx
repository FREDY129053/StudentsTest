	...
	return (
		<>
            ...
            <Modal isOpen={visible} toggle={toggle}>
                <ModalHeader  style={{color:"white",justifyContent: "center", backgroundColor:"#212529"}}>Photo</ModalHeader>
                ...
                <ModalFooter style={{display:"flex", justifyContent:"center", backgroundColor:"#212529"}}> <Button type="button" onClick={() => toggle()}>Cancel</Button></ModalFooter>
            </Modal>
		</>
	)
}
